...
;(function()
{
    ...
    {
        let strDuration = parseFloat(document.getElementById("Strength").value);
        let fraDuration = parseFloat(document.getElementById("Frailty").value);
    ...
    HL.BossSelected = function(index, value)
    {
        ...
        else if (HL.bossIndex == 18)
            HL.OutputTimeToKill(HL.CalculateTimeWithAdds(90, 7000, 1));
        else
    ...
    HL.CalculateTimeWithAdds = function(addInterval, addHP, addNumber)
    {
        ...
        let initialHP = parseFloat(HL.bossHP);
