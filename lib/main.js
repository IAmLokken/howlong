...
;(function()
{
    ...
    HL.BossSelected = function(index, value)
    {
        ...
        HL.CalculateTimeline(HL.GetTimelineName());
        return;
        if(HL.bossIndex == 14)
    ...
    HL.GetTimelineName = function()
    {
        let floorNumber = (parseInt(HL.bossIndex) + 1) + "0";
        let dungeon = HL.dungeonName == "Heaven-on-High" ? "HOH" : "POTD";
        console.log("Timeline name: " + dungeon + floorNumber);
